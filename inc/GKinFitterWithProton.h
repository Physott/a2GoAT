#ifndef _GKinFitterWithProton_h
#define _GKinFitterWithProton_h
...
public:
    GMyTrackWithProtonM(const Double_t beamEnergy, const TLorentzVector& p0, const TLorentzVector& p1, const TLorentzVector& p2, const TLorentzVector& p3, const TLorentzVector& p4, const TLorentzVector& p5, const TLorentzVector& proton);
    ~GMyTrackWithProtonM();
...
public:
    GMyTrackWithProtonH(const GMyTrackWithProtonM& m);
    ~GMyTrackWithProtonH();
...
public:
    GKinFitterWithProton();
    ~GKinFitterWithProton();

    Double_t        ConfidenceLevel()       {return TMath::Prob(fchi2,7);}//Note should be Ncon-Nunknowns
    Double_t        GetChi2()               {return fchi2;}
    ...
    void            Set(const Double_t beamEnergy, const TLorentzVector& p0, const TLorentzVector& p1, const TLorentzVector& p2, const TLorentzVector& p3, const TLorentzVector& p4, const TLorentzVector& p5, const TLorentzVector& proton);
    void            Reset();
    Bool_t          Solve();
};
