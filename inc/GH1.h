...
protected:
    ...
    virtual TH1*	AddHistogram(const TString& _Name, const TString& _Title) = 0;
            void    WriteBin(TDirectory &dir, const Int_t channel);
...
public:
    GH1D(const TString& name, const TString& title, const Int_t NumberOfBins, const Double_t min, const Double_t max);
    GH1D(const char* name, const char* title, const Int_t NumberOfBins, const Double_t min, const Double_t max);
    virtual ~GH1D();
};
...
public:
    GH1I(const TString& name, const TString& title, const Int_t NumberOfBins, const Int_t min, const Int_t max);
    GH1I(const char* name, const char* title, const Int_t NumberOfBins, const Int_t min, const Int_t max);
    virtual ~GH1I();
};
