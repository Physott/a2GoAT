...
GMyTrackM::GMyTrackM(const Double_t beamEnergy, const TLorentzVector& p0, const TLorentzVector& p1, const TLorentzVector& p2, const TLorentzVector& p3, const TLorentzVector& p4, const TLorentzVector& p5)
{
...
TMatrixD    GMyTrackM::GetDerivatedParametersH()    const
{
    TMatrixD    ret(40,33);
    for(int i=0; i<40; i++)
    {
...
void    GKinFitter::Set(const Double_t beamEnergy, const TLorentzVector& p0, const TLorentzVector& p1, const TLorentzVector& p2, const TLorentzVector& p3, const TLorentzVector& p4, const TLorentzVector& p5)
{
    GMyTrackH   parameters(GMyTrackM(beamEnergy, p0, p1, p2, p3, p4, p5));
